...
import type { Session, SessionServiceItem, Client, MaterialEntry } from '@/types/models';
...
export default function MyWorkPage() {
  ...
  const openMaterialModal = (session: Session, service: SessionServiceItem) => {
    ...
    const wasPrefilledFromMemory = existing.length === 0 && prefilled.length > 0;
    setMaterials(prefilled);
    setPrefillNotice(wasPrefilledFromMemory ? 'Cargado de la última vez con esta clienta · Revisá y ajustá si es necesario' : '');
  ...
  return (
    <div className="space-y-6 p-4 max-w-lg mx-auto">
      ...
      <Modal
        ...
        onClose={() => { setMaterialModal(null); setMaterials([]); setPrefillNotice(''); }}
      ...
      >
        <div className="space-y-4 pb-16 sm:pb-0">
          ...
          <div className="flex gap-2 pt-2">
            <Button variant="secondary" className="flex-1 py-3" onClick={() => { setMaterialModal(null); setMaterials([]); setPrefillNotice(''); }}>
              {ES.actions.cancel}
            </Button>
