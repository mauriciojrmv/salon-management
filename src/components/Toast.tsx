...
export function Toast({ notifications, onDismiss }: ToastProps) {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[9998] space-y-2 w-full max-w-sm px-4 pointer-events-auto sm:bottom-auto sm:top-4 sm:right-4 sm:left-auto sm:translate-x-0 sm:px-0">
      {notifications.map((n) => (
